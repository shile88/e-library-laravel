@extends('cruds.settings.index', [
    ...
    'breadcrumbs' => [['name' => 'Settings', 'href' => route('settings.index')], ['name' => 'Global variables', 'href' => route('global_variables.index')], ['name' => 'New global variable', 'href' => route('global_variables.create')]],
])
