                ...
                <thead class="bg-[#EFF3F6]">
                    <tr class="border-b-[1px] border-[#e4dfdf]">
                        ...
                        <th id="kategorijeMenu" class="relative px-4 py-4 text-sm tracking-wider text-left">
                            Kategorija<i class="ml-2 fas fa-filter"></i>
                        </th>
                ...
                <tbody class="bg-white">
                    @foreach ($books as $book)
                        <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                            ...
                            <td class="px-4 py-4 text-sm leading-5 ">{{ $book->authors[0]->name }}</td>
                            <td class="px-4 py-4 text-sm leading-5 ">{{ $book->categories[0]->name }}</td>
